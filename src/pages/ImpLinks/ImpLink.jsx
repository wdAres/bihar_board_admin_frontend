...
import { impLinkColumn } from '../../utils/Columns'
...
const ImpLink = () => {
    ...
    const columns = impLinkColumn((id) => navigate(`edit/${id}`), handleDelete)
    ...
    return (
        <>
            ...
            >
                <PageHeader heading={'ImpLink'} >
                    <Button onClick={() => navigate('add')} type='primary' icon={<FaPlus />}  >Add ImpLink</Button>
                </PageHeader>
